...
SECRET_KEY = 'django-insecure-wjgrtovp3gbi!rta$5hex9=6ayx)i^=#urx*3stn+y^a(9k(d='
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('127.0.0.1', 6379)],  # Adjust if your Redis server is on a different host or port
        },
    },
}
